...
for s = 1:S
    ...
    for k = 1:K
        ...
        % ---- Logistic Regression ----
        mdl = fitglm(Xtr,ytr,'Distribution','binomial');
        
        p_pos = predict(mdl,Xte);
...
fprintf('\n=== Logistic Regression (%d seeds, %d-fold CV) ===\n',S,K);
