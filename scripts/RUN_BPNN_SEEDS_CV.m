...
for s = 1:S
    ...
    for k = 1:K
        ...
        % ----- BPNN -----
        % Keep architecture consistent with manuscript if needed
        net = patternnet(200); % earlier it was 20–15–15 
        ...
        % One-hot targets for patternnet
        ...
        p_pos = yhat(2,:)';         % probability of class 1
